...
import{readallbyreferenceid,groupreadAwaitingAuthorizationRadiologyoptimized,groupreadAwaitingAuthorizationProcedureoptimized,groupreadawatingauthorizationpharmacytransaction,groupreadawatingauthorizationlabtransaction,readallhistopathologyAwaitingAuthorization,authorizeTransaction,fetchInsuranceClaims,updateInsuranceClaimStatus,authorizeTransactiongroup}  from '../controllers/insuranceclaimsandauthorization/insuranceandclaims';
...
router.post('/groupauthorizeclaims/:referencecategory/:testid', authorizeTransactiongroup); 
