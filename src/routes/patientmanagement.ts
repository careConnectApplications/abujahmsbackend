...
import {createpatients,getallpatients,updatepatients,uploadpix,getonepatients,bulkuploadhmopatients,getallhmopatients,searchpartient} from '../controllers/patientmanagement/patientmanagement';
