...
export const inpatientattendancereports=(startdate:any,enddate:any)=>{
const inpatientdischarges:any = [
      {   
         $match:{$and:[{updatedAt:{ $gt: startdate, $lt: enddate }},{ status: configuration.admissionstatus[5] }]}  
