...
exports.familyplanningreports = void 0;
const config_1 = __importDefault(require("../../config"));
const familyplanningreports = (startdate, enddate) => {
    const newfamilyplanningacceptorsByGender = [
        ...
        },
        {
            $match: {
                $or: [
                    { oralnewacceptor: config_1.default.familyplanningyesnooption[0] },
                    { injectableacceptor: config_1.default.familyplanningyesnooption[0] },
                    { iudinnewacceptor: config_1.default.familyplanningyesnooption[0] },
                    { implantsinnewacceptor: config_1.default.familyplanningyesnooption[0] },
                    { iudoutnewacceptor: config_1.default.familyplanningyesnooption[0] },
                    { barriernewacceptor: config_1.default.familyplanningyesnooption[0] },
                    { naturalemthodsnewacceptorforcyclebeads: config_1.default.familyplanningyesnooption[0] },
                    { naturalemthodsnewacceptorforothers: config_1.default.familyplanningyesnooption[0] }
                ]
            }
        },
        {
    ...
    const counselCountByGender = [
        ...
        {
            $match: {
                counsellingonfamilyplanning: config_1.default.familyplanningyesnooption[0]
            }
        },
        {
            $lookup: {
    ...
    const moderncontraceptionbyagegroup = [
        ...
        { $unwind: "$patientInfo" },
        {
            ...
            $match: {
                "patientInfo.gender": config_1.default.gender[1]
            }
        },
        {
    ...
    const emergencyContraceptiveDispensed = [
        {
            ...
            $match: {
                emergencycontraception: config_1.default.familyplanningyesnooption[0],
                createdAt: { $gt: startdate, $lt: enddate }
    ...
    const implantsInsertedByType = [
        {
            $match: {
                $or: [
                    { implantsinnewacceptor: config_1.default.familyplanningyesnooption[0] },
                    { implantsinrevisit: config_1.default.familyplanningyesnooption[0] }
                ],
    ...
    const iudInserted = [
        {
            $match: {
                $or: [
                    { iudinnewacceptor: config_1.default.familyplanningyesnooption[0] },
                    { iudinrevisit: config_1.default.familyplanningyesnooption[0] }
                ],
                typeofiud: { $nin: [null, ""] },
                createdAt: { $gt: startdate, $lt: enddate }
            }
    ...
    const sterilizationByGender = [
        {
            $match: {
                voluntorysterilization: config_1.default.familyplanningyesnooption[0], // "Yes"
                createdAt: { $gt: startdate, $lt: enddate }
            }
        },
        {
    ...
    const maleCondomsDistributed = [
        {
            $match: {
                typeofbarriermethods: config_1.default.typeofbarriermethods[6],
    ...
    const femaleCondomsDistributed = [
        {
            $match: {
                typeofbarriermethods: config_1.default.typeofbarriermethods[7],
                barrierquantity: { $gt: 0 },
                createdAt: { $gt: startdate, $lt: enddate }
            }
        },
    ...
    const postpartumCounsellingCount = [
        {
            $match: {
                counsellingonpostpartumfamilyplanning: config_1.default.familyplanningyesnooption[0],
                createdAt: { $gt: startdate, $lt: enddate }
            }
        },
        {
    ...
    const postPartumImplanonInsertions = [
        {
            $match: {
                implantsinnewacceptor: config_1.default.familyplanningyesnooption[0],
                typeofimplants: config_1.default.typeofimplants[0],
                createdAt: { $gt: startdate, $lt: enddate }
            }
        },
        {
    ...
    const postPartumJadelleInsertions = [
        {
            $match: {
                implantsinnewacceptor: config_1.default.familyplanningyesnooption[0],
                typeofimplants: config_1.default.typeofimplants[1],
                createdAt: { $gt: startdate, $lt: enddate }
            }
        },
        {
...
exports.familyplanningreports = familyplanningreports;
