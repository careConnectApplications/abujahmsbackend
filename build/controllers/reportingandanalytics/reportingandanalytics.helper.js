...
exports.formatDiseaseCasesReport = exports.formatEyeConditionReport = exports.reportdeath = exports.reportimmunization = exports.reportradiology = exports.reportpharmacy = exports.reportprocedure = exports.reportlab = exports.reportbyfinancialreport = exports.reportbyadmissionreport = exports.reportbyappointmentreport = exports.buildFilters = exports.formatRow = exports.removeEmptyStrings = void 0;
...
const formatEyeConditionReport = (eyeData) => {
...
exports.formatEyeConditionReport = formatEyeConditionReport;
// Helper function to format disease cases report
const formatDiseaseCasesReport = (rawData, predefinedDiseases) => {
    const result = {};
    ...
    rawData.forEach(item => {
        ...
        if (predefinedDiseases && predefinedDiseases.length > 0) {
            ...
            let matchedDisease = predefinedDiseases.find(disease => disease.toLowerCase() === diagnosis.toLowerCase());
            // If no exact match, try partial match
            if (!matchedDisease) {
                matchedDisease = predefinedDiseases.find(disease => diagnosis.toLowerCase().includes(disease.toLowerCase()) ||
    ...
    diseaseArray.forEach((disease, index) => {
        disease.sn = index + 1;
    });
    return diseaseArray;
};
exports.formatDiseaseCasesReport = formatDiseaseCasesReport;
